                        ...
                        <div class="intel-pills">
                            ${companyInfo.intelligence.top_products.map(product => 
                                `<span class="intel-pill" 
                                       onclick="event.stopPropagation(); if(window.kwic) window.kwic.show('${escapeHtml(product).replace(/'/g, "\\'")}', 'products')"
                        ...
                        <div class="intel-pills">
                            ${companyInfo.intelligence.ai_technologies.map(tech => 
                                `<span class="intel-pill tech-tag" 
                                       onclick="event.stopPropagation(); if(window.kwic) window.kwic.show('${escapeHtml(tech).replace(/'/g, "\\'")}', 'technologies')"
                                       title="Click to see where this appears">
                                    ${escapeHtml(tech)}
                                </span>`
                            ).join('')}
